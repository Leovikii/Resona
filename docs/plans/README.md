...
计划状态依次为 `Proposed`、`Accepted`、`Completed`。只有项目所有者确认后才能从 Proposed 进入 Accepted 并开始功能开发。

本目录只保留仍约束当前交付的计划：

- [0.1.0-rc.1 Windows 发布候选收尾](0.1.0-rc.1.md)：Implemented，遗留原生验收并入 rc.2
- [0.1.0-rc.2 播放呈现、更新体验与音频压缩优化](0.1.0-rc.2.md)：Implemented，原生问题并入 rc.3
- [0.1.0-rc.3 Windows 媒体呈现与控件收尾](0.1.0-rc.3.md)：Completed
- [0.1.0-rc.4 窄屏交互与播放器分页收尾](0.1.0-rc.4.md)：Implemented，待 Windows 实机验收
